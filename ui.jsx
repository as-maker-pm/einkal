...
function PageHeader({ title, subtitle, actions }) {
  return (
    <div style={{
      ...
      borderBottom: "0.5px solid var(--divider)", minHeight: 48,
    }}>
      <div style={{ flex: 1, minWidth: 0, display: "flex", alignItems: "baseline", gap: 10 }}>
        <h1 style={{ margin: 0, fontSize: 14, fontWeight: 500, letterSpacing: "-0.01em", lineHeight: 1, whiteSpace: "nowrap" }}>{title}</h1>
        {subtitle && <span style={{ color: "var(--muted)", fontSize: 12, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{subtitle}</span>}
      </div>
